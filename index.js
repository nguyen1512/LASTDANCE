const contentLetterSrart_actived = "Đôi lời gửi em!! Chúc em tuổi mới vui vẻ có nhiều niềm vui và k còn phải buồn " //Lời mở đầu cho bức thư
const mainContentLetter = "Mong những điều tốt đẹp nhất sẽ đến với em. Em sẽ hạnh phúc nhiều hơn k còn phải buồn ko còn phải có cảm giác k an toàn. Mong trên gương mặt em chỉ là nụ cười hạnh phúc chứ ko p nước mắt đau buồn. Anh xin lỗi là anh quá đáng với em rồi. ANh kì vọng cao quá so với hiện thực để r lại làm em p khóc. Đều do anh sai ANH XIN LỖI" //Nội dung của bức thư
